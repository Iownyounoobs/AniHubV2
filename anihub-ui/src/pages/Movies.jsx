    ...
    <div style={s.page}>
      ...
      <div style={s.container}>
        ...
        <div style={s.pageHeader}>
          ...
          <h1 style={s.pageTitle}>MOVIES</h1>
          <div style={s.headerLine} />
        </div>

        {loading ? (
          <div style={s.statusMsg}>LOADING MOVIES...</div>
        ) : movies.length === 0 ? (
          <div style={s.statusMsg}>NO MOVIES FOUND.</div>
        ) : (
          <>
            <div style={s.grid}>
            ...
            <div style={s.pagination}>
              ...
              {getVisiblePages().map((pg) => (
                <button
                  ...
                  style={pg === page ? s.pageBtnActive : s.pageBtn}
                >
                  {pg}
                </button>
              ))}
...
const s = {
  ...
  accentBar: { width: 4, height: 28, borderRadius: 2, flexShrink: 0, background: "#c084fc", boxShadow: "0 0 12px #c084fc" },
  pageTitle: {
    fontSize: "0.9rem", fontWeight: 700, letterSpacing: "0.25em", margin: 0,
    color: "#c084fc", textShadow: "0 0 18px #c084fc", whiteSpace: "nowrap",
    fontFamily: "'Orbitron', 'Share Tech Mono', monospace",
  },
  headerLine: { flex: 1, height: 1, opacity: 0.5, background: "linear-gradient(to right, rgba(192,132,252,0.4), transparent)" },
  ...
  card: { overflow: "hidden", cursor: "pointer", border: "1px solid rgba(192,132,252,0.12)", transition: "border-color 0.2s, box-shadow 0.2s" },
  cardHover: { overflow: "hidden", cursor: "pointer", border: "1px solid rgba(192,132,252,0.5)", boxShadow: "0 0 20px rgba(192,132,252,0.1)", transition: "border-color 0.2s, box-shadow 0.2s" },
  ...
  pageBtn: {
    background: "transparent", color: "#555", border: "1px solid rgba(192,132,252,0.2)",
  ...
  pageBtnActive: {
    background: "rgba(192,132,252,0.1)", color: "#c084fc", border: "1px solid rgba(192,132,252,0.7)",
    boxShadow: "0 0 12px rgba(192,132,252,0.2)", cursor: "pointer", minWidth: 38, height: 38,
